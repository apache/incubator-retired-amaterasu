...
echo "repo: ${REPO} "
CMD="java -cp ${BASEDIR}/lib/amaterasu-assembly-0.1.0.jar -Djava.library.path=/usr/lib io.shinto.amaterasu.leader.mesos.JobLauncher" #--repo "https://github.com/roadan/amaterasu-job-sample.git" --branch master
